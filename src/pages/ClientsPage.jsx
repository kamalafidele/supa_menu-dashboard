            ...
            <Wrapper>
                ...
                <Content>
                    <div className="add-new">
                        <div>
                           <span style={{ fontWeight: 'bold', fontSize: 20, textAlign: 'left' }}>New Client</span>
                        </div>
                        <div className='add-client'>
                            <span style={{ color: COLOR_PALETTE.GRAY }}>Add a new client</span>
                                ...
                                <tbody>
                                    { CLIENTS.map((client, index) => (
                                        <tr key={index}>
                                            <td>{client.name}</td>
                                            <td>{client.sales}</td>
                                            <td><i className="fa-solid fa-eye" style={{ color: COLOR_PALETTE.PRIMARY }}></i></td>
                                            <td><span style={{ background: COLOR_PALETTE.LIGHT_DARK, color: COLOR_PALETTE.WHITE, padding: 4, borderRadius: 15 }}>{client.category}</span></td>
                                            <td><i className="fa-solid fa-ellipsis-vertical" style={{ cursor: 'pointer'}}></i></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
