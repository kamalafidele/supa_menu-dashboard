            ...
            <div className="top-container">
                ...
                <div className='description-container'>
                    ...
                    <div className="btns-container">
                        <Button text={'Register your restaurant'} width={45} onClick={() => navigate('/signup')}/>
                        <Button text={'Restaurant already registered? Signin'} background={COLOR_PALETTE.BLACK} border='1px solid white' width={45} onClick={() => navigate('/login')}/>
                    </div>
                </div>
            </div>
